...
import 'verifiaction_code_page.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  final passwordAgainControl = TextEditingController();
  String? contactNo;
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: double.maxFinite,
                  child: TextFormField(
                    controller: contactControl..text = '923331234567',
  ...
  Future<void> _checkAccount(BuildContext context) async {
    ...
    final res = await NetworkClient().post('api/check-account');
    Map<String, dynamic> mp = json.decode(res.toString());
    if (res.statusCode == 200) {
      // ignore: use_build_context_synchronously
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => OtpVerificationPage(data: mp['data']),
      ));
    } else if (res.statusCode == 422) {
      print('fzn 888888888888');
